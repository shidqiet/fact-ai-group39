...
device = "cuda"
name = "Julianvn/facts-fw-med-new"  # TODO: change with your own trained fineweb model
...
@track_emissions(output_file="emissions_sae_16.csv")
def main():
    def train_sae(model, dataset, layer, point_name, tag="paper-repro"):
        ...
        def tokenize_fn(examples):
            ...
            if tokenizer is None:
                ...
                tokenizer = AutoTokenizer.from_pretrained("Julianvn/facts-fw-med-new")
